...
SELECT 
    r1.product_id,
    -- r1.product_family,
    r1.product_sub_family,
    SUM(r1.current_revenue-r2.current_revenue) AS downsell_revenue
FROM 
    revenue_table as r1
INNER JOIN
    revenue_table as r2
...
AND
    r1.product_sub_family = r2.product_sub_family
AND
...
GROUP BY
    ...
    r1.product_id
ORDER BY
    downsell_revenue DESC,r1.product_sub_family
